...
const SvgPython3Icon = ({ className }: React.SVGProps<SVGSVGElement>) => (
...
const Python3 = styled(SvgPython3Icon)`
...
const MemoSvgPython3Icon = React.memo(Python3)
export default MemoSvgPython3Icon
